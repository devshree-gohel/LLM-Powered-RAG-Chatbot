...
def run_lab_04():
    ...
    # 1. Document Loading
    print("\n--- 1. Document Parsing & Metadata Attachment ---")
    ...
    # 3. Strategy 2: Recursive Character Chunking
    ...
    # 4. Strategy 3: Sliding Window Chunking
    ...
    # 5. Strategy 4: Semantic Similarity Chunking
